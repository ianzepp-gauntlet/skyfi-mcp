 ...
 */
export function registerAoiTools(server: McpServer, client: SkyFiClient, alertStore?: AlertStore) {
  ...
  server.registerTool("get_aoi_alerts", {
    ...
    inputSchema: {
      monitor_id: z.string().optional().describe("Optional monitor/notification UUID to filter alerts"),
      limit: z.number().optional().describe("Maximum number of alerts to return (default: 25)"),
    },
    annotations: { readOnlyHint: true },
